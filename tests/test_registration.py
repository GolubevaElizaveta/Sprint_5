...
from src.helpers import create_random_email, create_random_password, create_email_base
...
class TestRegistration:
    ...
    # Проверка появления подсказки при вводе НЕ валидного по длине значения в поле "Пароль"
    @pytest.mark.parametrize('wrong_password', ['11111','1',])
